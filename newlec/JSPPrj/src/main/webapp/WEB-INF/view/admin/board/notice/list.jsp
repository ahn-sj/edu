					...
					<div class="notice margin-top">
						...
						<table class="table">
							...
							<tbody>
								...
								<%-- 기본값은 없는걸로 하고 만약 조건이 일치하는 경우에 checked 설정 --%>
								<c:set var="open" value=""></c:set>
									<c:if test="${n.pub}"> <%-- checked 조건확인 --%>
										<%-- open이라는 키워드로 checked속성을 넣을 수 있다 --%>
									...
									<tr>
										...
										<td class="title indent text-align-left"><a
											...
											class="text-orange text-strong"> [${n.cmtCount}]</span></td>
										<td>${n.writerId}</td>
										<td>${n.regDate}</td>
										<td>${n.hit}</td>
										<%-- 다중값들이 들어올 수 있는데 값을 배열로 넘긴다 --%>										
